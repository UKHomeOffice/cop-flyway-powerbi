...
export FLYWAY_PLACEHOLDERS_POWERBIOWNERNAME=${DB_POWERBI_POWERBI_OWNER_USERNAME}
export FLYWAY_PLACEHOLDERS_POWERBIOWNERPASSWORD=${DB_POWERBI_POWERBI_OWNER_PASSWORD}
...
STATUS=$( psql postgresql://${DB_POWERBI_DEFAULT_USERNAME}@${DB_POWERBI_HOSTNAME}:${DB_POWERBI_PORT}/${DB_POWERBI_DEFAULT_DBNAME}${DB_POWERBI_OPTIONS} -tc "SELECT 1 FROM pg_database WHERE datname='${DB_POWERBI_POWERBIERENCE_DBNAME}'" | sed -e 's/^[ \t]*//')
if [[ "${STATUS}" == "1" ]]
then
...
export FLYWAY_URL="jdbc:postgresql://${DB_POWERBI_HOSTNAME}:${DB_POWERBI_PORT}/${DB_POWERBI_POWERBIERENCE_DBNAME}${DB_POWERBI_JDBC_OPTIONS}"
export FLYWAY_USER=${DB_POWERBI_POWERBI_OWNER_USERNAME}
export FLYWAY_PASSWORD=${DB_POWERBI_POWERBI_OWNER_PASSWORD}
export FLYWAY_SCHEMAS=${DB_POWERBI_POWERBI_SCHEMA}
export FLYWAY_PLACEHOLDERS_SCHEMA=${DB_POWERBI_POWERBI_SCHEMA}
export FLYWAY_PLACEHOLDERS_AUTHENTICATORUSER=${DB_POWERBI_POWERBI_AUTHENTICATOR_USERNAME}
export FLYWAY_PLACEHOLDERS_AUTHENTICATORPASSWORD=${DB_POWERBI_POWERBI_AUTHENTICATOR_PASSWORD}
export FLYWAY_PLACEHOLDERS_ANONUSER=${DB_POWERBI_POWERBI_ANON_USERNAME}
export FLYWAY_PLACEHOLDERS_SERVICEUSER=${DB_POWERBI_POWERBI_SERVICE_USERNAME}
export FLYWAY_PLACEHOLDERS_READONLYUSER=${DB_POWERBI_POWERBI_READONLY_USERNAME}
